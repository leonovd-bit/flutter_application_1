...
class ChooseMealPlanPageV3New extends StatefulWidget {
  final bool isSignupFlow;
  
  const ChooseMealPlanPageV3New({
    super.key,
    this.isSignupFlow = false,
  });

  @override
  State<ChooseMealPlanPageV3New> createState() => _ChooseMealPlanPageV3NewState();
}

class _ChooseMealPlanPageV3NewState extends State<ChooseMealPlanPageV3New> {
