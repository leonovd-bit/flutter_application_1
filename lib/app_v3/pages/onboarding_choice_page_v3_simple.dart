...
class OnboardingChoicePageV3Simple extends StatelessWidget {
  const OnboardingChoicePageV3Simple({super.key});
  ...
  void _navigateToMealPlanSelection(BuildContext context) {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => const ChooseMealPlanPageV3New(isSignupFlow: true),
      ),
    );
  }
